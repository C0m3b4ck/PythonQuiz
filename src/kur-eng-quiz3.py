...
Australia_foods_facts = [
    ...
    "First made in 1923 from left-over beer production yeast. Invented in Melbourne, used as a salty and savoury paste.",
    "A tradition coming from England.",
...
# //NEW ZEALAND
# for a country - requires: country_MAX_regions, country_regions_questions, country_regions_answers_lowercase, country_regions_answers_uppercase, country_regions_facts
New_Zealand_MAX_foods = 12
New_Zealand_foods_questions = [
    "What is rolled during the Rolling of the Balls in Dunedin?: ",
...
New_Zealand_foods_facts = [
    "Small orange-coated chocolate balls. 40,000 of them are rolled in the Rolling of the Balls.",
...
Canada_foods_facts = [
    "Invented in Quebec around the 1950s, consists of french fries with cheese, meat and gravy sauce.",
    "Invented in Quebec around the 1950s, consists of french fries with cheese, meat and gravy sauce.",
    "Scottish origins - dense and chewy bread.",
    "Scottish origins - dense and chewy bread.",
...
def information(type):
    if type == "us":
        ...
        print("\n")
        print("----Northwest----")
        print("Harsh winters, indigeneus peoples, cowboy culture")
        print("\n")
        ...
        print("\n")
        print("----Southwest----")
        print("Tex-mex, indigineus people from reservations, corn and beans common")
        print("\n")
        ...
        print("\n")
        print("---Bannock---")
        print("Scottish origins - dense and chewy bread.")
        print("\nPress enter to continue: ")
        input()
...
def repeat_wrong_answers(type, mode, wrong_indices):
    """Repeat only wrong answers with ORIGINAL print format"""
    print(f"--- REPEATING {len(wrong_indices)} WRONG ANSWERS ---\n")

    answers_correct_repeat = 0
    answers_wrong_repeat = 0

    for selected_question in wrong_indices:
        answer = (
            str(
                input(
        ...
        if answer == correct_ans_lower or answer == correct_ans_upper:
            ...
            answers_wrong_repeat += 1

    print(
        calculate_percentage(
            answers_correct_repeat, answers_correct_repeat + answers_wrong_repeat
        )
    )
...
def fillintheblanks(type, mode):
    ...
    if choice == "y" and answers_wrong_list:  # Check if wrong answers exist
        repeat_wrong_answers(type, mode, answers_wrong_list)
    else:
